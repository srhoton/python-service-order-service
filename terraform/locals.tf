locals {
  ...
  lambda_environment_variables = {
    ...
    APPCONFIG_ENVIRONMENT_ID           = aws_appconfig_environment.service_order.environment_id
    APPCONFIG_CONFIGURATION_PROFILE_ID = aws_appconfig_configuration_profile.service_order.configuration_profile_id
    LOG_LEVEL                          = "INFO"
  }
}
